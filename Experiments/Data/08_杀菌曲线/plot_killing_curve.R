...
#
# 异常值处理:
#   - WP6组(W2 MOI=0.01)的G6孔异常(Max V=+3.4，细菌持续生长)
#   - 已排除G6，仅使用E6和F6的平均值
#   - 可能原因：加样失误（漏加噬菌体）
...
# W2 MOI=0.01 (WP6: 仅E6,F6均值，排除异常G6孔)
# G6孔Max V=+3.4(细菌生长)，可能加样失误，予以排除
W2_MOI001 <- c(0.273, 0.317, 0.352, 0.418, 0.444, 0.458, 0.473, 0.494, 0.516, 0.541,
               0.550, 0.543, 0.503, 0.372, 0.209, 0.189, 0.183, 0.181, 0.193, 0.208,
               0.225, 0.249, 0.272, 0.289, 0.322, 0.356, 0.389, 0.432, 0.490, 0.549,
               0.587, 0.624, 0.686, 0.703, 0.747, 0.762, 0.801, 0.830, 0.853, 0.871,
               0.884, 0.899, 0.910, 0.918, 0.923, 0.930, 0.938, 0.944, 0.952)
